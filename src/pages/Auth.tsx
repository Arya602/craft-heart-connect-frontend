      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold bg-gradient-warm bg-clip-text text-transparent mb-2">
            Welcome to Tinker Tryst
          </h1>
          <p className="text-muted-foreground">Sign in to start your craft journey</p>
        </div>
          ...
          <TabsContent value="signup">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Join our community of craft lovers</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
